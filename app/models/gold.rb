class Gold < ActiveRecord::Base
  ...
  # return a hash of type=> pct of golds with reasons
  def self.reasoned_percent_by_type
    ...
    all.each do |type_classname,count|
      ...
      pcts[type_short_name] = 0.0
      pcts[type_short_name] = with_reasons[type_classname].to_f / count.to_f if with_reasons.has_key? type_classname   
    end
    pcts
  end
